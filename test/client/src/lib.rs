...
pub type ParachainBlockData = forest_primitives_core::ParachainBlockData<Block>;
...
/// Test client builder for Forest
...
fn genesis_config() -> GenesisConfig {
	forest_test_service::local_testnet_genesis()
}
