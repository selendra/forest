...
use selendra_primitives::v2::UpgradeGoAhead;
...
impl Default for RelayStateSproofBuilder {
	fn default() -> Self {
		RelayStateSproofBuilder {
			...
			host_config: forest_primitives_core::AbridgedHostConfiguration {
...
impl RelayStateSproofBuilder {
	...
	pub fn into_state_root_and_proof(
		self,
	) -> (selendra_primitives::v2::Hash, sp_state_machine::StorageProof) {
		let (db, root) = MemoryDB::<HashFor<selendra_primitives::v2::Block>>::default_with_root();
