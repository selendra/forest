...
async fn test_runtime_upgrade() {
	...
	// run forest dave (a parachain full node)
	let dave = forest_test_service::TestNodeBuilder::new(para_id, tokio_handle, Dave)
	...
	let wasm = forest_test_runtime::wasm_spec_version_incremented::WASM_BINARY
