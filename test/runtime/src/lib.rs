...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("forest-test-parachain"),
	impl_name: create_runtime_str!("forest-test-parachain"),
	authoring_version: 1,
	// Read the note above.
	spec_version: 1,
	impl_version: 1,
...
impl forest_pallet_parachain_system::Config for Runtime {
	...
	type CheckAssociatedRelayNumber = forest_pallet_parachain_system::AnyRelayNumber;
}

parameter_types! {
	pub storage ParachainId: forest_primitives_core::ParaId = 100.into();
}
