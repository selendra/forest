...
use selendra_overseer::{prometheus::PrometheusError, Handle as OverseerHandle};
use selendra_service::SubstrateServiceError;
...
pub enum RelayChainError {
	...
	#[error("Selendra service error: {0}")]
	ServiceError(#[from] selendra_service::Error),
