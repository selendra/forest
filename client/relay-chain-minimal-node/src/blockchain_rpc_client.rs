...
use forest_relay_chain_interface::{RelayChainError, RelayChainResult};
use forest_relay_chain_rpc_interface::RelayChainRpcClient;
...
impl BlockChainRpcClient {
	...
	pub async fn block_get_hash(
		&self,
		number: Option<selendra_service::BlockNumber>,
...
impl RuntimeApiSubsystemClient for BlockChainRpcClient {
	async fn validators(
		&self,
		at: Hash,
	) -> Result<Vec<selendra_primitives::v2::ValidatorId>, sp_api::ApiError> {
	...
	async fn validator_groups(
		...
		(
			Vec<Vec<selendra_primitives::v2::ValidatorIndex>>,
			selendra_primitives::v2::GroupRotationInfo<selendra_core_primitives::BlockNumber>,
		),
		sp_api::ApiError,
	> {
	...
	async fn availability_cores(
		...
		Vec<selendra_primitives::v2::CoreState<Hash, selendra_core_primitives::BlockNumber>>,
		sp_api::ApiError,
	> {
	...
	async fn persisted_validation_data(
		&self,
		at: Hash,
		para_id: forest_primitives_core::ParaId,
		assumption: selendra_primitives::v2::OccupiedCoreAssumption,
	) -> Result<
		Option<
			forest_primitives_core::PersistedValidationData<
				Hash,
				selendra_core_primitives::BlockNumber,
			>,
		>,
		sp_api::ApiError,
	> {
	...
	async fn assumed_validation_data(
		...
		Option<(
			forest_primitives_core::PersistedValidationData<
				...
				selendra_core_primitives::BlockNumber,
			>,
			selendra_primitives::v2::ValidationCodeHash,
		)>,
		sp_api::ApiError,
	> {
		Ok(self
	...
	async fn check_validation_outputs(
		...
		at: Hash,
		para_id: forest_primitives_core::ParaId,
		outputs: selendra_primitives::v2::CandidateCommitments,
	...
	async fn session_index_for_child(
		&self,
		at: Hash,
	) -> Result<selendra_primitives::v2::SessionIndex, sp_api::ApiError> {
	...
	async fn validation_code(
		...
		para_id: forest_primitives_core::ParaId,
		assumption: selendra_primitives::v2::OccupiedCoreAssumption,
	) -> Result<Option<selendra_primitives::v2::ValidationCode>, sp_api::ApiError> {
	...
	async fn candidate_pending_availability(
		...
		at: Hash,
		para_id: forest_primitives_core::ParaId,
	) -> Result<Option<selendra_primitives::v2::CommittedCandidateReceipt<Hash>>, sp_api::ApiError>
	{
		Ok(self
			.rpc_client
	...
	async fn candidate_events(
		&self,
		at: Hash,
	) -> Result<Vec<selendra_primitives::v2::CandidateEvent<Hash>>, sp_api::ApiError> {
	...
	async fn dmq_contents(
		&self,
		at: Hash,
		recipient: forest_primitives_core::ParaId,
	) -> Result<
		Vec<forest_primitives_core::InboundDownwardMessage<selendra_core_primitives::BlockNumber>>,
		sp_api::ApiError,
	> {
	...
	async fn inbound_hrmp_channels_contents(
		...
		std::collections::BTreeMap<
			forest_primitives_core::ParaId,
			Vec<
				selendra_core_primitives::InboundHrmpMessage<selendra_core_primitives::BlockNumber>,
			>,
		>,
		sp_api::ApiError,
	> {
	...
	async fn validation_code_by_hash(
		&self,
		at: Hash,
		validation_code_hash: selendra_primitives::v2::ValidationCodeHash,
	) -> Result<Option<selendra_primitives::v2::ValidationCode>, sp_api::ApiError> {
		Ok(self
			.rpc_client
	...
	async fn on_chain_votes(
		&self,
		at: Hash,
	) -> Result<Option<selendra_primitives::v2::ScrapedOnChainVotes<Hash>>, sp_api::ApiError> {
	...
	async fn session_info(
		&self,
		at: Hash,
		index: selendra_primitives::v2::SessionIndex,
	) -> Result<Option<selendra_primitives::v2::SessionInfo>, sp_api::ApiError> {
	...
	async fn session_info_before_version_2(
		...
		at: Hash,
		index: selendra_primitives::v2::SessionIndex,
	) -> Result<Option<selendra_primitives::v2::OldV1SessionInfo>, sp_api::ApiError> {
	...
	async fn submit_pvf_check_statement(
		&self,
		at: Hash,
		stmt: selendra_primitives::v2::PvfCheckStatement,
		signature: selendra_primitives::v2::ValidatorSignature,
	...
	async fn pvfs_require_precheck(
		&self,
		at: Hash,
	) -> Result<Vec<selendra_primitives::v2::ValidationCodeHash>, sp_api::ApiError> {
	...
	async fn validation_code_hash(
		...
		para_id: forest_primitives_core::ParaId,
		assumption: selendra_primitives::v2::OccupiedCoreAssumption,
	) -> Result<Option<selendra_primitives::v2::ValidationCodeHash>, sp_api::ApiError> {
		Ok(self
			.rpc_client
	...
	async fn authorities(
		&self,
		at: Hash,
	) -> std::result::Result<Vec<selendra_primitives::v2::AuthorityDiscoveryId>, sp_api::ApiError> {
	...
	async fn api_version_parachain_host(&self, at: Hash) -> Result<Option<u32>, sp_api::ApiError> {
		let api_id = <dyn selendra_primitives::runtime_api::ParachainHost<Block>>::ID;
	...
	async fn disputes(
		...
		Vec<(
			selendra_primitives::v2::SessionIndex,
			selendra_primitives::v2::CandidateHash,
			selendra_primitives::v2::DisputeState<selendra_primitives::v2::BlockNumber>,
		)>,
		ApiError,
	> {
...
impl HeaderBackend<Block> for BlockChainRpcClient {
	fn header(
		&self,
		id: BlockId,
	) -> sp_blockchain::Result<Option<<Block as selendra_service::BlockT>::Header>> {
	...
	fn number(
		&self,
		hash: <Block as selendra_service::BlockT>::Hash,
	) -> sp_blockchain::Result<
		Option<<<Block as selendra_service::BlockT>::Header as selendra_service::HeaderT>::Number>,
	> {
	...
	fn hash(
		&self,
		number: selendra_service::NumberFor<Block>,
	) -> sp_blockchain::Result<Option<<Block as selendra_service::BlockT>::Hash>> {
