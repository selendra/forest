...
//! Forest related core primitive types and traits.

#![cfg_attr(not(feature = "std"), no_std)]

use codec::{Decode, Encode};
use selendra_parachain::primitives::HeadData;
...
pub use selendra_primitives::v2::{
...
pub mod relay_chain {
	...
	pub use selendra_primitives::{runtime_api, v2, v2::well_known_keys};
}

/// An inbound HRMP message.
pub type InboundHrmpMessage = selendra_primitives::v2::InboundHrmpMessage<relay_chain::BlockNumber>;

/// And outbound HRMP message
pub type OutboundHrmpMessage = selendra_primitives::v2::OutboundHrmpMessage<ParaId>;
