...
//! forest-pallet-parachain-system is a base pallet for forest-based parachains.
//!
...
use forest_primitives_parachain_inherent::{MessageQueueChain, ParachainInherentData};
use frame_support::{
...
/// # fn main() {}
/// ```
pub use forest_pallet_parachain_system_proc_macro::register_validate_block;
...
pub mod pallet {
	...
	impl<T: Config> ProvideInherent for Pallet<T> {
		...
		const INHERENT_IDENTIFIER: InherentIdentifier =
			forest_primitives_parachain_inherent::INHERENT_IDENTIFIER;
...
impl<T: Config> Pallet<T> {
	...
	/// [`ValidationParams`](selendra_parachain::primitives::ValidationParams).
	///
	...
	fn process_inbound_horizontal_messages(
		ingress_channels: &[(ParaId, forest_primitives_core::AbridgedHrmpChannel)],
	...
	/// [`CollectCollationInfo`](forest_primitives_core::CollectCollationInfo) runtime api.
