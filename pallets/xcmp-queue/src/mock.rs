...
use forest_pallet_parachain_system::AnyRelayNumber;
use forest_primitives_core::{IsSystem, ParaId};
...
impl frame_system::Config for Test {
	...
	type OnSetCode = forest_pallet_parachain_system::ParachainSetCode<Test>;
...
impl forest_pallet_parachain_system::Config for Test {
	type RuntimeEvent = RuntimeEvent;
	type OnSystemEvent = ();
	type SelfParaId = ();
